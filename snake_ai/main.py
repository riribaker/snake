...
class Application:
    ...
    def execute(self):
        ...
        # Error checking since we're allowing students to change the board dimensions
        if utils.DISPLAY_SIZE % utils.GRID_SIZE != 0:
            print(f"ERROR: Your DISPLAY_SIZE OF {utils.DISPLAY_SIZE} is not divisible by your GRID_SIZE {utils.GRID_SIZE}.")
            return
...
def main():
    parser = argparse.ArgumentParser(description='CS440 Snake')
